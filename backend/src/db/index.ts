...
const DB_PATH = process.env.DB_PATH || path.resolve(__dirname, '../../../data/weijing_drama.db')
...
sqlite.exec(`
  ...
  CREATE INDEX IF NOT EXISTS idx_creative_sessions_scope_drama_episode
    ON creative_sessions (scope, drama_id, episode_id, status);
  ...
  CREATE INDEX IF NOT EXISTS idx_creative_messages_session_id
    ON creative_messages (session_id);
