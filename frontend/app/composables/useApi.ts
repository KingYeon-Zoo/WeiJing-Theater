...
export const aiConfigAPI = {
  ...
  weijingPreset: (apiKey: string) => api.post('/ai-configs/weijing-preset', { api_key: apiKey }),
}
...
export const skillsAPI = {
  ...
  listPacks: () => api.get('/skills/packs'),
  getPack: (agentType: string) => api.get(`/skills/packs/${agentType}`),
  updatePack: (agentType: string, data: any) => api.put(`/skills/packs/${agentType}`, data),
}
...
export const creativeAPI = {
  createSession: (data: { scope: 'drama' | 'episode'; drama_id: number; episode_id?: number | null }) => api.post('/creative/sessions', data),
  getSession: (id: number) => api.get(`/creative/sessions/${id}`),
  sendMessage: (id: number, message: string) => api.post(`/creative/sessions/${id}/messages`, { message }),
  commitSession: (id: number, data?: any) => api.post(`/creative/sessions/${id}/commit`, data || {}),
}
